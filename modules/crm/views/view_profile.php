                                            ...
                                            foreach ($myArray as $key){ ?> 
                                              ...
                                              <?php
                                                  ...
                                                  foreach ($chat_message as $key1) { ?>
                                                    <h5 class="mt-0 mb-1"><a href="<?php echo base_url();?>index.php/crm/leads/live_chat/<?php echo $key['id']; ?>" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"><?php echo $key1['name']; ?></a></h5>
