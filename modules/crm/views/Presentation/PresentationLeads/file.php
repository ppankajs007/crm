                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                         <li class="breadcrumb-item"><a href="<?php echo base_url();?>">CRM</a></li>
                          ...
                          <li class="breadcrumb-item"><a href=" <?php echo base_url()."crm/Presentation/dashboard/".$this->uri->segment(4); ?>">Dashboard</a></li>
                    ...
                    <div class="row total_list">
                        <div class="col-md-12">
                            <div class="additional_list">
                                <header class="panel-heading">Files <a href="<?php echo base_url()."crm/Presentation/add_file/".$this->uri->segment(4); ?>" class="add_file waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a" id="modal_disable"><i class="mdi mdi-plus-circle mr-1"></i> Add File</a></header>
