    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                      <li class="breadcrumb-item"><a href="<?php echo base_url();?>">CRM</a></li>
                          <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/Qualified/">Presentation Leads</a></li>
                          <li class="breadcrumb-item"><a href=" <?php echo base_url()."crm/Qualified/dashboard/".$this->uri->segment(4); ?>">Dashboard</a></li>
                ...
                <h4 class="page-title">Presentation Leads(#<?php echo $id. ' '.$lead[0]->first_name;?>)</h4>
            </div>
        </div>
    </div>      
    <!-- end page title --> 
                    ...
                    <div class="row total_list">
                        <div class="col-md-12">
                            <div class="additional_list">
                                <header class="panel-heading">Task</header>
                                <table id="" class="table dt-responsive nowrap" id="DataTable">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Task Name</th>
                                    ...
                                    ?>
                                                <tr class="Mystyle<?php echo  $lead->id; ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url();?>crm/Presentation/edit_task/<?php echo  $lead->id; ?> "class="action-icon" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"> <i class="mdi mdi-square-edit-outline"></i></a>
