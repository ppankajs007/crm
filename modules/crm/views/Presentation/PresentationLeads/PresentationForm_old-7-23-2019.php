...
.request_optons .form-check.form-check-inline input {
    margin-top: -8px;
}
...
.request_optons .form-check.form-check-inline label {
    font-weight: 400;
}
        </style>
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/Presentation">Presentation Leads</a></li>
                                             <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/Presentation/dashboard/<?php echo $pw_pending[0]['lead_id']; ?>">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Kitchen Details</li>
                                        </ol>
                                    </div>
                                    <?php  //$id=$this->uri->segment(4);
                                    
                                    $lead= App::get_by_where('leads', array('id'=>$pw_pending[0]['lead_id']) );
                                    
                                    //print_r($lead);
                                    
                                    ?>

                                    <h4 class="page-title">Presentation Lead(#<?php echo $pw_pending[0]['lead_id']. ' '.$lead[0]->first_name;?>)</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                            <ul class="overview_list" id="lead_sub_menu">
                                              <?php  echo modules::run('includes/Presentation_sub_menu');?>
                                             </ul>
   ...
   <div class="form-group">
            ...
            <div class="row">
               ...
               <div class=row>
                ...
                <!--              <option value="">Select Option</option>-->
                <!--      <option value="N/A"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == 'N/A'){ echo 'selected';}} ?>>N/A</option>-->
                <!--      <option value="24"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '24'){ echo 'selected';}} ?>>24</option>-->
                <!--      <option value="30"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '30'){ echo 'selected';}} ?>>30</option>-->
                <!--      <option value="36"<?php //if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '36'){ echo 'selected';}} ?>>36</option>-->
                <!--       <option value="42"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '42'){ echo 'selected';}} ?>>42</option>-->
                <!--        <option value="45"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '45'){ echo 'selected';}} ?>>45</option>-->
                <!--         <option value="48"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '48'){ echo 'selected';}} ?>>48</option>-->
                <!--         <option value="60"<?php// if(isset($pw_pending[0]['cooktop_size'])){ if($pw_pending[0]['cooktop_size'] == '60'){ echo 'selected';}} ?>>60</option>-->
                  ...
                  <div class=row>
                    ...
                    <div class="form-group ">
                     ...
                     <select class="form-control" name="hood"  data-toggle="select2">
                      ...
                      <option value="Stainless Steel Hood"<?php if(isset($pw_pending[0]['hood'])){ if($pw_pending[0]['hood'] == 'Wood Hood'){ echo 'selected';}} ?>>Stainless Steel Hood</option>
                ...
                <div class="col-6">
                 ...
                 <div class=row>
                     <div class="col-12">
                    <div class="request_optons">
                        <label for="name">Option Requests</label></br>
                        
                         
                     
                     
                      <?php
                      if( isset($pw_pending[0]['option_request']) ){ $option_request = explode(', ', $pw_pending[0]['option_request']);
                      }else{
                      ...
                      ?>
                         ...
                         <div class="form-check form-check-inline">
                             <input type="checkbox" <?php if(in_array("Roll Out Trays", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Roll Out Trays" id="roll_out">&nbsp;<label for="roll_out">Roll Out Trays</label>
                            </div>
                        <div class="form-check form-check-inline">
                         <input type="checkbox" <?php if(in_array("In Cabinet Trash", $option_request)){ echo "checked"; } ?> name="option_request[]" value="In Cabinet Trash" id="cabinet_t">&nbsp;<label for="cabinet_t">In Cabinet Trash</label>
                        </div>
                        <div class="form-check form-check-inline">
                         <input type="checkbox"  <?php if(in_array("Pantry", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Pantry" id="pantry">&nbsp;<label for="pantry">Pantry</label>
                         </div>
                          <div class="form-check form-check-inline">
                              <input type="checkbox" <?php if(in_array("Spice Racks", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Spice Racks" id="spice_r">&nbsp;<label for="spice_r">Spice Racks </label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input type="checkbox" <?php if(in_array("Glass", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Glass" id="glass_">&nbsp;<label for="glass_">Glass</lable>
                         
                         </div>
                          <div class="form-check form-check-inline">
                              <input type="checkbox" <?php if(in_array("Lazy Susan Wall", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Lazy Susan Wall" id="lazy_susan">&nbsp; <label for="lazy_susan">Lazy Susan Wall</label>
                          </div>
                          <div class="form-check form-check-inline">
                               <input type="checkbox" <?php if(in_array("Lazy Susan Base", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Lazy Susan Base" id="lazy_susan_base">&nbsp;<label for="lazy_susan_base">Lazy Susan Base</label>
                               </div>
                        <div class="invalid-feedback"></div>
