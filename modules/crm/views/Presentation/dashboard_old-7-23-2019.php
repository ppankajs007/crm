               ...
               $lead['name'] = $this->db->where('id',$leads[0]->assigned_to)->get('user_profiles')->row()->name;
                 ...
                 $surveyQus = $this->crm_model->findWhere('survey_answers', array('lead_id' => $leads[0]->id), true, array('answer') );
                                ...
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Presentation Leads (#<?php echo $leads[0]->id. ' '. $leads[0]->first_name ;?>)</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="row total_list">
                                            <div class="col-md-3">
                                                ...
                                                <label>Current Status</label>
                                                 ...
                                                 <h5><strong> <?php if( !empty( $lead['status'] ) ){ echo $lead['status']; } else { echo 'N/A'; }?>  </strong>  </h5>
                                                </div> 
                                            </div>
                                            <div class="col-md-3">
                                                <div class="box_outer">
