<div class="modal-demo">
    <button type="button" class="close" onclick="Custombox.modal.close();">
     ...
     <?php if( empty($leads) ) return; extract($leads);$name1= @$first_name.' '.@$last_name;   ?>
        ...
        <div class="form-group">
            ...
            <?php //echo $action_lead; ?>
             <select  class="form-control" id="action_lead" name="action_lead"  data-toggle="select2" name="action_lead">
                    <?php
            ...
            <!-- <select class="form-control" name="action_lead" value="<?php echo $action_lead;?>" data-toggle="select2"> 
                    <option value="" <?php if(empty($action_lead) ){ echo "selected"; } ?>>Select option</option>
        ...
        <div class="form-group">
            <?php   if(!empty($reminder_date)){ $datetime = $reminder_date; $rem = date("m-d-Y", strtotime($datetime));
                                }else{   $rem="";   } ?>
            <label>Next step Date (MM-DD-YYYY)</label>
            <input type="text" id="reminder_date" name="reminder_date" value="<?php echo $rem;?>"class="form-control">
        </div>
        <div class="form-group">
