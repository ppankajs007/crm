        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    </div><?php  $id=$this->uri->segment(4); $lead= App::get_by_where('leads', array('id'=>$id) );?>
        ...
        <div class="row total_list">
            <div class="col-md-12">
                <div class="additional_list">
                    <header class="panel-heading">Files <a href="<?php echo base_url()."crm/Qualified/add_file/".$this->uri->segment(4); ?>" class="add_file waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a" id="modal_disable"><i class="mdi mdi-plus-circle mr-1"></i> Add File</a></header>
