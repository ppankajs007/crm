   ...
   ?>
                                                <tr class="Mystyle<?php echo  $lead->id; ?>">
                                                   ...
                                                   <td><?php echo ucwords($daname['first_name'].' '.$daname['last_name']); ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url();?>crm/Qualified/edit_task/<?php echo  $lead->id; ?> "class="action-icon" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"> <i class="mdi mdi-square-edit-outline"></i></a>
