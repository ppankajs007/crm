          ...
          <div class="col-md-6">
           <div class="form-group">
               <input type="hidden" id="old_qf_status" name="old_qf_status" value="<?php echo $qf_status;?> ">
                ...
                <label for="">Status</label> <a href="<?php echo base_url();?>crm/Qualified/add_task/<?php echo $id;?>" class="action-icon create-customer task_b" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a" id="pstatus_popup"><i class="fa fa-plus-square" aria-hidden="true" ></i></a>
           ...
           <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    if(!empty($leads['qf_dateRecieved'] ) ){ 
         ...
         <!-- other fileds start  -->
           ...
           <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="qf_Kit_File_2" value="<?php if( !empty( $KitFilesF[1]['file_name'] ) ){ echo base_url().'assets/'.$KitFilesF[1]["file_name"];   } ?>" id="qf_Kit_File_2" readonly >
              </div> 
           </div>
