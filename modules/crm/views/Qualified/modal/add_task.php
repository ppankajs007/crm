    ...
    <h4 class="custom-modal-title">Add Task</h4>
        <div class="custom-modal-text text-left">
            <div class="after-add-more">
                <fieldset>
                    <legend><span class="task_no">Task</span></legend>
                    <div class="form-group">
                        ...
                        ?>
                        <input type="hidden" id='hiddenstatus' name="qf_status" value="<?php echo $lostValue;?>" class="form-control">
                        <input type="hidden" name="task[main0][lead_id]" value="<?php echo $id;?>" class="form-control lead_id" id="lead_id">
                        <input type="hidden" name="fullname" value="<?= $fullname; ?>" class="form-control lead_id" id="full_name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control deadline_date" id="deadline_date" name="task[main0][deadline_date]" placeholder="Enter Deadline Date">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="task[main0][assigned_team]" value=""> 
                            ...
                            <?php foreach ($lead_statuss as $us) { ?> 
