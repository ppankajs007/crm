                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Qualified Revision Leads</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Qualified Revision Leads</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                       <ul class="lead_list assign_list">
                                        ...
                                        <table id="qualifiedleadsresTable" class="display table dtr-inline no-footer " cellspacing="0" style="width:100%">
                                        <!--<table id="qualifiedleadsTable" class="table no-footer nowrap dataTable dtr-inline collapsed" style="width:100%"> -->
                                           <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Name</th>
