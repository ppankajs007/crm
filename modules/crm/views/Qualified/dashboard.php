    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="page-title-box">
                ...
                <h4 class="page-title">Qualified Leads (#<?php echo $leads[0]->id. ' '. $leads[0]->first_name ;?>)</h4>
            </div>
        </div>
    </div><!-- end row -->
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="additional_list">
                                <header class="panel-heading"> Paperwork Details <a href="<?php echo base_url();?>crm/PWleads/edit/<?php echo $leads[0]->id; ?>" class="add_file waves-effect waves-light" data-animation="fadein" data-plugin="" data-overlaycolor="#38414a" id="modal_disable" target="_blank"><i class="fe-edit-2"></i></a>
                                </header>
                                <ul class="list-group no-radius">
                                    <li class="list-group-item">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="additional_list">
                                <header class="panel-heading"> Qualified Details <a href="<?php echo base_url();?>crm/Qualified/edit/<?php echo $leads[0]->id; ?>" class="add_file waves-effect waves-light" data-animation="fadein" data-plugin="" data-overlaycolor="#38414a" id="modal_disable"><i class="fe-edit-2"></i></a></header>
                            </div>
                        </div>
                    </div>
                    <div class="row">
