                                ...
                                <div class="card">
                                    <div class="card-body">
                                      <div class="row mb-2">
                                        ...
                                        <table id="MRleadsTable" class="display nowrap table dataTable dtr-inline" cellspacing="0" style="width:100%">
                                       <!-- <table id="MRleadsTable" class="table no-footer nowrap dataTable dtr-inline collapsed" style="width:100%"> -->
                                           <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Customer Name</th>
