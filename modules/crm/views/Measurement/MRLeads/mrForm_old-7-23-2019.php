                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>crm/MRLeads">Measurement Required</a></li>
                                             <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/MRLeads/dashboard/<?php echo $pw_pending[0]['lead_id']; ?>">Dashboard</a></li>
                                    ...
                                    ?>
                                    <h4 class="page-title">Measurement Required (#<?php echo $id.' ' .$lead[0]->first_name.' '.$lead[0]->last_name;?>)</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
