                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                          <li class="breadcrumb-item"><a href="<?php echo base_url();?>">CRM</a></li>
                                              <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/>Measurement Required/">Measurement Required</a></li>
                                              <li class="breadcrumb-item"><a href=" <?php echo base_url()."crm/>Measurement Required/dashboard/".$this->uri->segment(4); ?>">Dashboard</a></li>
                                    ...
                                    <h4 class="page-title">Measurement Required(#<?php echo $id. ' '.$lead[0]->first_name;?>)</h4>
                                </div>
                            </div>
                        </div>      
                        <!-- end page title --> 
   ...
   ?>
                                                <tr class="Mystyle<?php echo  $lead->id; ?>">
                                                   ...
                                                   <td><?php echo ucwords($daname['first_name'].' '.$daname['last_name']); ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url();?>crm/MRLeads/edit_task/<?php echo  $lead->id; ?> "class="action-icon" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"> <i class="mdi mdi-square-edit-outline"></i></a>
