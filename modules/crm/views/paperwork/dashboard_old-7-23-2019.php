        ...
        <div class="container-fluid">                       
                        ...
                        <div class="row">
                            <div class="col-12">
                             ...
                             <h4 class="page-title">Paperwork Pending (#<?php echo $leads[0]->id. ' '. $leads[0]->first_name .' '.$leads[0]->last_name;?>)  </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                             ...
                                             <div class="col-md-6">
                                                <div class="additional_list">
                                                    ...
                                                    <ul class="list-group no-radius">
                                                        ...
                                                        <li class="list-group-item">
                                                             <?php
                                                             if(!empty($hold[0]->hold_next_step_date)){
                                                                 $hold_next_step_date = crm_date($hold[0]->hold_next_step_date);
                                                                 /*$new_date1 = strtotime($hold[0]->hold_next_step_date);
                                                                 $hold_next_step_date = date('m/d/Y', $new_date1);*/
                                                             }else{
                                                                $hold_next_step_date='--'; 
                                                             }
                                                             ?>
                                  ...
                                  <div class="col-md-6">
                                                <div class="additional_list">
                                                        ...
                                                        <li class="list-group-item">
                                                             ...
                                                             <?php
                                                             if(!empty($leads[0]->qf_dateRecieved)){
                                                                 $qf_dateRecieved = crm_date( $leads[0]->qf_dateRecieved );
                                                                 /*
                                                                 $new_date1 = strtotime($leads[0]->qf_dateRecieved);
                                                        ...
                                                        <li class="list-group-item">
                                                             <?php
                                                             if(!empty($leads[0]->qf_dateAdded)){
                                                                  $qf_dateAdded = crm_date($leads[0]->qf_dateAdded);
                                                                 /*$new_date1 = strtotime($leads[0]->qf_dateAdded);
                                                          ...
                                                          <li class="list-group-item">
                                                               ...
                                                               <?php
                                                             if(!empty($leads[0]->qf_datestarted)){
                                                                $qf_datestarted = crm_date($leads[0]->qf_datestarted);
                                                                /*$new_date1 = strtotime($leads[0]->qf_datestarted);
                                                        ...
                                                        <li class="list-group-item">
                                                             <?php
                                                             if(!empty($leads[0]->qf_dateCompleted)){
                                                                 $qf_dateCompleted = crm_date($leads[0]->qf_dateCompleted);
                                                               /* $new_date1 = strtotime($leads[0]->qf_dateCompleted);
                                                        ...
                                                        <li class="list-group-item">
                                                            <?php
                                                             if(!empty($leads[0]->qf_dateSent)){
                                                                $qf_dateSent = crm_date($leads[0]->qf_dateSent);
                                                                /*$new_date1 = strtotime($leads[0]->qf_dateSent);
                                                                $qf_dateSent = date('m/d/Y', $new_date1);*/
                                                             }else{
                                                                $qf_dateSent='--'; 
                                                             }
                                                             ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="additional_list">
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12">
                                                            <div class="additional_list">
                                                            <header class="panel-heading">Kitchen Details</header></div>
                                                    </div>
                                                    </div>
