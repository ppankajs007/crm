                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/PWleads">Paperwork Pending</a></li>
                         <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/PWleads/dashboard/<?php echo $leads['id']; ?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Notes</li>
                    </ol>
                </div>
                
                <?php  
                    $lead= App::get_by_where('leads', array('id'=>$leads['id']) );
                ?>
                <h4 class="page-title">Paperwork Pending(#<?php echo $leads['id'].' '.$lead[0]->first_name.' '.$lead[0]->last_name;?>)</h4>
            </div>
        </div>
    </div>     
    <!-- end page title --> 
                    ...
                    <div class="row total_list">
                        <div class="col-md-12">
                            <div class="additional_list">
                                ...
                                <?php $attributes = array('id' => 'form'); echo form_open($this->uri->uri_string(),$attributes); // form open here ?>
