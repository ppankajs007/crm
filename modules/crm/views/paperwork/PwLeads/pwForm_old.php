                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/PWleads">Paperwork Pending</a></li>
                                             <li class="breadcrumb-item"><a href="<?php echo base_url();?>crm/PWleads/dashboard/<?php echo $pw_pending[0]['lead_id']; ?>">Dashboard</a></li>
                                    ...
                                    ?>
                                    <h4 class="page-title">Paperwork Pending(#<?php echo$pw_pending[0]['lead_id'].' '.$lead[0]->first_name.' '.$lead[0]->last_name;?>)</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                 ...
                 <div class=row>
                    ...
                    <div class="form-group ">
                      ...
                      ?>
                       ...
                       <input type="checkbox" <?php if(in_array("Roll Out Trays", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Roll Out Trays">&nbsp;Roll Out Trays
                         <input type="checkbox" <?php if(in_array("In Cabinet Trash", $option_request)){ echo "checked"; } ?> name="option_request[]" value="In Cabinet Trash">&nbsp;In Cabinet Trash
                         <input type="checkbox"  <?php if(in_array("Pantry", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Pantry">&nbsp;Pantry
                          <input type="checkbox" <?php if(in_array("Spice Racks", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Spice Racks">&nbsp;Spice Racks 
                          <input type="checkbox" <?php if(in_array("Glass", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Glass">&nbsp;Glass
                          <input type="checkbox" <?php if(in_array("Lazy Susan Wall", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Lazy Susan Wall">&nbsp;Lazy Susan Wall
                           <input type="checkbox" <?php if(in_array("Lazy Susan Base", $option_request)){ echo "checked"; } ?> name="option_request[]" value="Lazy Susan Base">&nbsp; Lazy Susan Base
                        <div class="invalid-feedback"></div>
                    </div>
