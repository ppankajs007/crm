    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                ?>
                <h4 class="page-title">Paperwork Pending(#<?php echo $id. ' '.$lead[0]->first_name;?>)</h4>
            </div>
        </div>
    </div>      
    <!-- end page title --> 
                                   ...
                                   <table id="" class="table dt-responsive nowrap" id="DataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="Mystyle<?php echo  $lead->id; ?>">
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url();?>crm/PWleads/edit_task/<?php echo  $lead->id; ?> "class="action-icon" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"> <i class="mdi mdi-square-edit-outline"></i></a>

                                                    <?php  
                                                    if ($id == $lead->created_by){ ?> 
