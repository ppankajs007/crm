            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><?php if( empty($leads) ) return; echo  ucfirst($leads[0]->first_name);?></li>
                    </ol>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="additional_list">
                                <header class="panel-heading"> Paperwork Details <a href="<?php echo base_url();?>crm/PWleads/edit/<?php echo $leads[0]->id; ?>" class="add_file waves-effect waves-light" data-animation="fadein" data-plugin="" data-overlaycolor="#38414a" id="modal_disable"><i class="fe-edit-2"></i></a></header>
                                <ul class="list-group no-radius">
                                     <li class="list-group-item">
