...
$globalMethods = array('index','edit','files','notes','chats','get_task','pw_form');
$rSc = rand(99,999);
    ...
    if($currentMethod == 'index' ) { ?>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                ...
                if( jQuery('#pwleadsTable').length ){
                    var dataTable = jQuery('#pwleadsTable').DataTable({ 
                        "processing": true,
                        "serverSide": true,
                        "stateSave": true,
                        "columnDefs": [ {
                        ...
                        "order": [ [0, "desc"] ],
                        "ajax": {
                            "url": "<?php echo base_url('crm/PWleads/getPWleads'); ?>",
                            "type": "POST",
                            error:function(res){
                              console.log(res);
                              $(".pwleadsTable-error").html("");
                              $("#pwleadsTable").append('<tbody class="pwleadsTable-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                              $("#pwleadsTable_processing").css("display","none");
                            },
                        },
