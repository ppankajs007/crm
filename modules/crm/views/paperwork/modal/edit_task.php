<div class="modal-demo">
    ...
    <?php $attributes = array('id' => 'form_task'); echo form_open($this->uri->uri_string(),$attributes); // form starts here ?>
    <?php 
    ...
    ?>
        ...
        <div class="custom-modal-text text-left">
            ...
            <?php 
                $leads = App::get_row_by_where('leads', array( 'id' => $task['lead_id']) ); 
            ?>
