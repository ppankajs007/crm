<div class="modal-demo">
    ...
    <?php 
        $attributes = array('id' => 'form_task'); 
        echo form_open($this->uri->uri_string(),$attributes); ?>
        <?php if( empty($task) ) return; ?>
    ...
    <div class="custom-modal-text text-left">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="status" value=""> 
                ...
                <option value="Pending" <?php echo (($task['status']=='Pending')?"selected":""); ?> id="0">Pending</option>
                <option value="completed" <?php echo (($task['status']=='completed')?"selected":""); ?> id="0">completed</option>
                <option value="close" <?php echo (($task['status']=='close')?"selected":""); ?> id="0">close</option>
            </select>
        </div>
        <div class="form-group" >
            ...
            <input type="hidden" name="lead_id" value="<?php echo $leads->id;?>" class="form-control lead_id" id="lead_id">
