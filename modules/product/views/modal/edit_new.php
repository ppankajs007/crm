    ...
    <div class="custom-modal-text text-left">
        <?php echo form_open($this->uri->uri_string(),array('id' => 'product-form')); ?>             
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="Item_description" name="Item_description" placeholder="Enter Item Description" value="<?php echo  $productData->description ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="Assembly" name="Assembly" placeholder="Enter Assembly Name" value="<?php echo  $productData->u_price ?>">
            </div>
             <div class="form-group">
