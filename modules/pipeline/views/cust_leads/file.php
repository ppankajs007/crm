                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="additional_list">
                                    <header class="panel-heading">Files  <a href="<?php echo base_url()."customer/add_file/".$this->uri->segment(3); ?>" class="add_file waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a" id="modal_disable"><i class="mdi mdi-plus-circle mr-1"></i> Add File</a></header>
                            ...
                            <thead>
                                ...
                                <tr class="Mystyle<?php echo  $value['file_id'] ?>">
                                    ...
                                    <td><a href="javascript:void(0);" id="deleteleadfile" class="action-icon" ids="<?php echo $value['file_id']; ?>" 
                                                     leads_id="<?php echo $this->uri->segment(3); ?>"> <i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr><?php }}else{?>
