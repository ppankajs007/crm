                    ...
                    <div class="card-body">
                        ...
                        <div class="row total_list">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="address">
                                        <div class="address">
                                            <address class="panel-headings">
                                              ...
                                              <?php $isShipping = $cdata[$bill]['shipping_option'];
                                                    if( in_array('Billing', array_column($cdata, 'address_type')) ){
                                                        ...
                                                        if ($cdata[$bill]['addressline_two']) echo '<br>'.$cdata[$bill]['addressline_two'];
                                                        echo '<br>'.$cdata[$bill]['city'].', '.$cdata[$bill]['state'].' '.$cdata[$bill]['zipcode']."<br>";
                                                        echo '<div class="addbtns"><a href="'.base_url().'customer/edit_address/'.$cdata[$bill]['id'].'/Billing" title="Edit" class="action-icon create-customer edit_butt" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"><i class="fas fa-edit"></i></a> ';
                                                        echo '<a href="javascript:void(0);" id="deleteAddress" class="action-icon de_button" ids="'.$cdata[$bill]['id'].'" cids="'.$this->uri->segment(3).'" data-toggle="" data-placement="top" title="Delete Lead"> <i class="mdi mdi-delete"></i></a></div>';
                                                    }else{
                                                        echo '<div class="addbtns"><a href="'.base_url().'customer/address_ads/'.$this->uri->segment(3).'/Billing" title="add" class="add_file" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a" id="modal_disable"><i class="mdi mdi-plus-circle mr-1"></i> Add Address</a></div>';
                                                    }
                                                   // echo $errorAddr;
                                                 ?>
                                            </address>
                                            ...
                                            <address class="panel-headings">
                                                ...
                                                <?php 
                                                    if( in_array('Shipping', array_column( $cdata, 'address_type') ) ){
                                                        ...
                                                        if ($cdata[$ship]['addressline_two']) echo '<br>'.$cdata[$ship]['addressline_two'];
                                                        echo '<br>'.$cdata[$ship]['city'].', '.$cdata[$ship]['state'].' '.$cdata[$ship]['zipcode']."<br>";
                                                        echo '<div class="addbtns"><a href="'.base_url().'customer/edit_address/'.$cdata[$ship]['id'].'/Shipping" title="Edit" class="action-icon create-customer edit_butt" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"><i class="fas fa-edit"></i></a> ';
                                                        echo '<a href="javascript:void(0);" id="deleteAddress" class="action-icon de_button" ids="'.$cdata[$ship]['id'].'" cids="'.$this->uri->segment(3).'" data-toggle="" data-placement="top" title="Delete Lead"> <i class="mdi mdi-delete"></i></a></div>';
                                                    }else{
                                                        echo '<div class="addbtns"><a href="'.base_url().'customer/address_ads/'.$this->uri->segment(3).'/Shipping" title="add" class="add_file" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a" id="modal_disable"><i class="mdi mdi-plus-circle mr-1"></i> Add Address</a></div>';
                                                    }
                                                  ?>
                                            </address>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="text-left">
                                        <a href='<?php echo base_url();?>customer/order/<?php echo $this->uri->segment(3); ?>' target='_blank' class="btn btn-danger waves-effect waves-light">Add New Order</a>
                                    </div>
                                    <div class="additional_list">
                                        ...
                                        <table class="display table compact">
                                            ...
                                            <tbody>
                                            <?php 
                                                foreach ($customer_orders as $key => $cOrder) {
                                                    $orId          = $cOrder['id'];
                                                    $status        = $cOrder['status'];
                                                    $vdrcode       = ( $cOrder['vdrcode'] )? :'N/A'; 
                                                    $sales_primary = ( $cOrder['upname'] )? :'N/A';
                                                    $total         = ( $cOrder['total'] )? :'0.00';
                                                    $paid          = ( $cOrder['payment_amount'] )? :'0.00';
                                                    $total_due     = $total - $paid;

                                                    if( !empty($paid) && !empty($total_due) ){
                                                        $paidN = ($total_due * 100)/$total;
                                                        $paidP = decimalValue($paidN).'%';
                                                    } else {
                                                        $paidP = '0.00%';
                                                    }

                                                   echo "<tr>
                                                    <td><a target='_blank' href='".base_url()."orders/Dashboard/".$orId."'>".$orId."</a></td>
                                                        <td>".$status."</td>
                                                        <td>".$sales_primary."</td>
                                                        <td>".$vdrcode."</td>
                                                        <td>".$total."</td>
                                                        ...
                                                        <td>".$total_due."</td>
                                                        <td>".$paidP."</td>
                                                        <td><a target='_blank' href='".base_url()."orders/Dashboard/".$orId."'  class='action-icon' data-animation='' data-plugin='' data-overlaycolor='#38414a'> <i class='fas fa-eye'></i></a></td>
                                                    </tr>";
                                                }; 
                                            ?>
                                            </tbody>
                                ...
                                <div class="col-md-12">
                                    <div class="additional_list">
                                        ...
                                        <table class="display table compact">
                                            ...
                                            <tbody>
                                            <?php 
                                                foreach ($customer_quotes as $key => $cOrder) {
                                                    $orId          = $cOrder['id'];
                                                    $status        = $cOrder['status'];
                                                    $vdrcode       = ( $cOrder['vdrcode'] )? :'N/A'; 
                                                    $sales_primary = ( $cOrder['upname'] )? :'N/A';
