                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                               <li class="breadcrumb-item"><a href="<?php echo base_url();?>">CRM</a></li>
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url();?>customer/dashboard/<?php echo $leads['id']; ?>">Dashboard</a></li>
                            ...
                            <div class="row total_list">
                                <div class="col-md-12">
                                    <div class="additional_list">
                                        ...
                                        <textarea id="noteEditor" name="comment" class="form-control"><?php echo $leads['comment']; ?></textarea>  
