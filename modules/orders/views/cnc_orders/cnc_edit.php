                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="vendorName" name="vendor" class="vendorName pro_item" >
                                         ...
                                         <?php 
                                         $vSelected = ( $this->uri->segment(2) == 'cncOrders' )? '4':'';
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="row margin-top">
                                <div class="col-md-6 add_custom_row">
                                   <a href="<?php echo base_url() ?>orders/CncOrders/addCustomProduct/<?php echo $this->uri->segment(4); ?>" title="Add Custom Product" class="btn btn-success waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a">Add Custom Product</a>
                                </div>
                                </div>
                           </div>
                        </div>                     
                            ...
                            if ( !empty($jk_products)) {
                              ...
                              // pr( $jk_products_child,1 );
                                    foreach ($jk_products as $key => $fProduct) {
                                        ...
                                        $this->view('cnc_orders/parent_template',$newProArr);
                                        foreach ($jk_products_child as $childkey => $childvalue) {
                                          if ( $childvalue['pro_order_id'] == $fProduct['POProId'] ) {
                                            ...
                                            echo $this->load->view('cnc_orders/child_template', $newChildProArr, TRUE);
                                          ...
                                          if ( $subchildvalue['pro_parent_id'] == $childvalue['product_id'] ) {
                                            ...
                                            echo $this->load->view('cnc_orders/subchild_template', $newSubChildProArr, TRUE);
                                          }
                                          }
