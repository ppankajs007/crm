               ...
               <div class="row">
                  ...
                  <div class="col-sm-6">
                     ...
                     <div class="col-md-12">
                      ...
                      <div class="row"><div class='col-md-4'>Customer Signature _______________</div><div class='col-md-4'>Date of Acknoledgements _______________</div></div><br><br><br>
                      

                      <?php if($order_view['payment_person'] == 'yes'){ ?>
                        <div class="pPerson">
                          <h5>
                              I, <?php echo $order_view['payment_person_name']; ?> authorize the use of my credit card to pay for this order. </h5><br>
                            <p>Signature _______________</p><br><br>
                        </div>
                    <?php } ?>
                      ...
                      <div class="colortone">
                          ...
                          <div class="row">
                              ...
                              <div class='col-md-6'>WoodMaster Order Number _______________________</div><br><br>
                              
                              <div class='col-md-6'>Dealer _______________________</div>
                              <div class='col-md-6'>Date _______________________</div> <br><br>
