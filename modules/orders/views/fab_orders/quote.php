                  ...
                  <div class="col-md-4 offset-md-2">
                     <div class="mt-3 float-right">
                        <div class="mt-3-print">
                          ...
                          <!-- <p class="m-b-10"><strong>Order Status : </strong> <span class="float-right"><span class="badge badge-danger"><?= $edit_order['status'];?></span></span></p> -->
                     ...
                     <div class="table-responsive">
                        <table class="table mt-4 table-bordered table-centered">
                          <thead>
                           ...
                           <tbody>
                              <?php $sum = 0; foreach ($fab_products as $key => $value) {
                                    extract( $value );
                                ?>
                                <tr>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-6">
                     <div class="float-right">
                     	<p><b>Subtotal : </b> <span class="float-right">$<?= decimalValue($sum); ?></span></p>
                       <?php if(!empty($edit_order['discount_per']) && $edit_order['discount_per'] != 0 ){
                            $discount_per = $edit_order['discount_per'];
                            $discount     = decimalValue( $sum*$edit_order['discount_per']/100 );
                        ...
                        <p><b>Total:</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; 
                           $<?php echo decimalValue($sum - $discount); ?></span>
                        </p>
                        <h3></h3>
                     </div>
                     </div>
