                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="vendorName" name="vendor" class="vendorName pro_item" >
                                         ...
                                         <?php 
                                         $vSelected = ( $this->uri->segment(2) == 'FabOrders' )? '2':'';
                                            foreach ($vendor as $ven) 
                                            {
                                            ?> 
                                         <option value="<?php echo $ven->id; ?>" <?php if( $vSelected == $ven->id ){echo 'selected';} ?> o_id = "<?= $this->uri->segment(4); ?>" >
                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="styleName" name="style" class="styleName" >
                                         <option value="0">Select...</option>
                                         <?php
                                          foreach ($fab_style as $key => $value) { ?>
                                              <option <?php if( $edit_order['style_id'] == $value->id ){echo 'selected';} ?> data-sCode = "<?php echo $value->style_code; ?>" data-sName = "<?php echo $value->style_name; ?>" value="<?php echo $value->id; ?>" >
                                ...
                                <div class="btn_content">
                                    ...
                                    <div class="btn_imp down_btn">
                                       <div class="download-file">
                                          <a href="<?= base_url(); ?>assets/productOrderfile/orderImportSample.xlsx" class="download-anc">Download Sample</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <table class="table table-bordere editProTable table-centered mb-0 input-height">
                           ...
                           <tbody>
                            ...
                            if ( !empty($fab_products)) {
                                    foreach ($fab_products as $key => $fProduct) {
                                        $parentC = uniqid();                                    
                                        $newProArr = array(
                                            'fabpro_id'         => $fProduct['product_id'],
                                            'pro_qty'           => $fProduct['qty'],
                                            'style_id'          => $fProduct['style_id'],
                                            ...
                                            'slab1_id'          => $fProduct['slab_one_id'],
                                            'slab1_sqft'        => $fProduct['slab_one_sqft'],
                                            'slab2_id'          => $fProduct['slab_two_id'],
                                            'slab2_sqft'        => $fProduct['slab_two_sqft'],
                                            'slab3_id'          => $fProduct['slab_three_id'],
                                            'slab3_sqft'        => $fProduct['slab_three_sqft'],
                                        ...
                                        $newProArr['prcnt_cost'] = number_format($calcPerc,2);
                                        $this->view('fab_orders/parent_template',$newProArr);
                                    }
                                } ?>
                           </tbody>
                        </table><br>
