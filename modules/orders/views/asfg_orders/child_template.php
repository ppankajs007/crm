...
<tr id='pro_<?php echo $jkPOCid; ?>' class='ischild parent_row<?php echo $pCount ?> add_row<?php echo $counttr; ?>' style="background: #00800052;">
    <td>
        <input type='number' min="1" data-proInput='<?php echo $counttr ?>' class='form-control qty' style='width:70px;' value='<?php echo $pro_qty; ?>' name='product[<?php echo $pCount; ?>][child_product][<?php echo $counttr ?>][qty]'  data-slabInput = '<?php echo $counttr ?>' id='qty<?php echo $counttr ?>'>
    </td>
    <td>
       ...
       <div class="icon_content">
        <div class="f_icon add_icon">
          ...
          <i data-product_id="" class="mdi mdi-plus-circle mr-1 add_subchild" id="add_subchild<?php echo $counttr; ?>" data_row_count = '<?php echo $counttr; ?>' data_parent_row="<?php echo $pCount; ?>" data_parent_id="<?php echo $pro_parent_id; ?>" data_item_code="<?php echo $item_code; ?>" data_style_id="<?php echo $style_id; ?>"></i>
             ...
             <input type="hidden" id="sale_price_input<?php echo $counttr ?>" name="product[<?php echo $pCount; ?>][child_product][<?php echo $counttr ?>][total_price]" class="sale_price_input" value="<?php echo $item_price; ?>">
