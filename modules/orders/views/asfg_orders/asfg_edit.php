                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="vendorName" name="vendor" class="vendorName pro_item" >
                                         ...
                                         <?php
                                         $vSelected = ( $this->uri->segment(2) == 'AsfgOrders' )? '8':'';
                            ...
                            if ( !empty($jk_products)) {
                                    foreach ($jk_products as $key => $fProduct) {
                                        ...
                                        $newProArr = array(
                                            ...
                                            'item_cost'         => ($fProduct['final_cost']) ? $fProduct['final_cost'] : '0.00',
                                            'item_price'        => ($fProduct['total_price']) ? $fProduct['total_price'] : '0.00',
                                        ...
                                        $this->view('asfg_orders/parent_template',$newProArr);
