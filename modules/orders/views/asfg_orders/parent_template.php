...
<tr id='pro_<?php echo $jkpro_id; ?>' class='proIparent add_row<?php echo $counttr ?>'>
    <td>
        <input type='number' min="1" class='form-control qty' style='width:70px;' value='<?php echo $pro_qty; ?>' name='product[<?php echo $counttr ?>][qty]'  data-proInput = '<?php echo $counttr ?>' id='qty<?php echo $counttr ?>'>
    </td>
