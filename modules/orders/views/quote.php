                                       ...
                                       foreach ($pro_view as $key => $value) {
                                        ...
                                        ?>
                                          <tr>
                                             ...
                                             <td width="5%"><b><?= $value->qty; ?></b></td>
                                             <td width="40%"><b><?= $value->item_descriptionII.' '.$width.$height.$depth; ?></b></td>
                                             <td width="20%" class="textright"><b>$<?= number_format($cust_price,2); ?></b></td>
                                          </tr>
                                          <?php if ( !empty($product_order_child) ) {
                                       		...
                                       		?>
                                                           <tr>
	                                             					...
	                                             					<td width="20%" class="textright"><b>$<?= number_format($cust_pricec,2); ?></b></td>
	                                                              </tr>
	                                                            <?php
	                                                            $subPrice[] = $cust_pricec;
                                             ...
                                             if( $order_view['assemble_value'] == 1 ){
                                                        $ted_pricecs = $valuesub['item_cost'];
                                                        $cust_pricecs = $valuesub['unassembled_retail_item_price'];
                                                    }else{
                                                        $ted_pricecs = $valuesub['cabinet_assembly_price'];
                                                        $cust_pricecs = $valuesub['assembled_retail_item_price'];
                                                    } 
				                                                   		...
				                                                   		?>
				                                                            <tr>
				                                             					...
				                                             					<td width="20%" class="textright"><b>$<?= number_format($cust_pricecs,2); ?></b></td>
				                                                              </tr>
				                                                            <?php
				                                                            $subPricechild[] = $cust_pricecs;
				                                                        }
				                                                    }
				                                                }
				                                            }
               ...
               <div class="row">
                  ...
                  <div class="col-sm-6">
                     <div class="float-right">
                     	<p><b>Subtotal:</b> <span class="float-right">$<?= number_format($total_sum,2); ?></span></p>
