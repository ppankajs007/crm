                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              <div class="radio radio-info form-check-inline">
                                  <input autocomplete="off" type="radio" id="assemble_item" class="assemble_val" value="0" name="assemble_value" <?php if( $edit_order['assemble_value'] == 0 ){ echo 'checked'; } ?> order_id = "<?= $this->uri->segment(4); ?>">
                              ...
                              <div class="radio form-check-inline">                            
                                  <input autocomplete="off" type="radio" id="uassemble_item" class="assemble_val" value="1" name="assemble_value"
                                   <?php if( $edit_order['assemble_value'] == 1 ){ echo 'checked'; } ?> order_id = "<?= $this->uri->segment(4); ?>" >
                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="vendorName" name="vendor" class="vendorName pro_item" >
                                         ...
                                         <?php
                                         $vSelected = ( $this->uri->segment(2) == 'jkOrders' )? '3':'';
                                      ...
                                      <select class="form-control" id="styleName" name="style" class="styleName" >
                                         ...
                                         <?php
                                          foreach ($jk_style as $key => $value) { ?>
                                              <option value="<?php echo $value->id; ?>" <?php if( $edit_order['style_id'] == $value->id ){echo 'selected';} ?> data-sCode = "<?php echo $value->style_code; ?>" data-sName = "<?php echo $value->style_name; ?>">
                        ...
                        <div class="col-md-6">
                              ...
                              <div class="col-md-6 position-relative">
                                 <div class="btn_content">
                                    <div class="btn_imp">
                                       ...
                                       <input type="submit" class="append_input btn btn-success waves-effect waves-light" name="submit" value="Import">
                                    </div>
                                    <div class="btn_imp down_btn">
                                       <div class="download-file">
                                          <a href="<?= base_url(); ?>assets/productOrderfile/importSample.xlsx" class="download-anc">Download Sample</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                          ...
                          <div class="row margin-top">
                              ...
                              <!-- <div class="col-md-4 import_input">
                                ...
                                <div class="col-md-4 add_custom_row">
                                   
                                  <!-- <a href="javascript:;" title="Add Custom" class="btn btn-success waves-effect waves-light" id="add_custom_product">Add Custom Product</a> -->

                                  <a href="<?php echo base_url() ?>orders/jkOrders/addCustomProduct/<?php echo $this->uri->segment(4); ?>" title="Add Custom Product" class="btn btn-success waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a">Add Custom Product</a>
                      ...
                      <div class="table-responsive table_append ">
                           ...
                           <tbody>
                            ...
                            if ( !empty($jk_products)) {
                                    foreach ($jk_products as $key => $fProduct) {
                                        ...
                                        $this->view('jk_orders/parent_template',$newProArr);
                                        ...
                                        $Cstyle_id = ( $childvalue['style_id'] ) ? $childvalue['style_id']:$childvalue['POStyleId'];
                                          if ( $childvalue['pro_order_id'] == $fProduct['POProId'] ) {
                                            ...
                                            $newChildProArr = array(
                                              ...
                                              'item_cost'         => $childvalue['final_cost'],
                                              'item_price'        => $childvalue['total_price'],
                                            ...
                                            echo $this->load->view('jk_orders/child_template', $newChildProArr, TRUE);
                                          

                                          foreach ($jk_products_subchild as $subchildkey => $subchildvalue) {
                                          if ( $subchildvalue['pro_parent_id'] == $childvalue['product_id'] ) {
                                            ...
                                            $newSubChildProArr = array(
                                              ...
                                              'item_cost'           => $subchildvalue['final_cost'],
                                              'item_price'          => $subchildvalue['total_price'],
                                              'jk_product'          => $jkClass->getChildProducts( $childvalue['style_id'],$childvalue['Item_Code']), 
                                              'parent_counter'      => $parentC,
                                            ...
                                            echo $this->load->view('jk_orders/subchild_template', $newSubChildProArr, TRUE);
                                          }
                                          }
                        ...
                        <div class="row subTotArea border_bottom">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="clearfix">
                              <label style="float: right">Total Products (<?php echo array_sum( $total_product ); ?>)</label>
                            </div>
