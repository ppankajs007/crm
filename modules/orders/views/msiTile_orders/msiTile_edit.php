...
.price_calcuate, .msi_des {
    margin: 10px 0;
}
.des_first .sqbox_input {
    float: right;
    width: 43% !important;
                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="vendorName" name="vendor" class="vendorName pro_item" >
                                         ...
                                         <?php
                                         $vSelected = ( $this->uri->segment(2) == 'msiTileOrders' )? '7':''; 
                            ...
                            if ( !empty($jk_products)) {
                                    foreach ($jk_products as $key => $fProduct) {
                                        ...
                                        $newProArr = array(
                                            ...
                                            'descriptionI'      => $fProduct['descriptionI'],
                                        ...
                                        $this->view('msiTile_orders/parent_template',$newProArr);
