                                ...
                                <div class="col-5">
                                   <div class="form-group">
                                      ...
                                      <select class="form-control" id="vendorName" name="vendor" class="vendorName pro_item" >
                                         ...
                                         <?php 
                                          $vSelected = ( $this->uri->segment(2) == 'wcOrders' )? '5':'';
                              ...
                              <div class="col-md-4 import_input">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-6 add_custom_row">
                                     <a href="<?php echo base_url() ?>orders/wcOrders/addCustomProduct/<?php echo $this->uri->segment(4); ?>" title="Add Custom Product" class="btn btn-success waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a">Add Custom Product</a>
                                  </div>
                                </div>
                           </div>
                        </div>                     
                            ...
                            if ( !empty($jk_products)) {
                                    foreach ($jk_products as $key => $fProduct) {
                                      //pr( $fProduct );
                                        ...
                                        $this->view('wc_orders/parent_template',$newProArr);
                                        ...
                                        foreach ($jk_products_child as $childkey => $childvalue) {
                                          ...
                                          if ( $childvalue['pro_order_id'] == $fProduct['POProId'] ) {
                                            ...
                                            $newChildProArr['prcnt_cost'] = number_format($calcChildPerc,2);
                                            echo $this->load->view('wc_orders/child_template', $newChildProArr, TRUE);
                                          ...
                                          if ( $subchildvalue['pro_order_id'] == $childvalue['jkPOCid'] ) {
                                            ...
                                            $newSubChildProArr['prcnt_cost'] = number_format($calcSubChildPerc,2);
                                            echo $this->load->view('wc_orders/subchild_template', $newSubChildProArr, TRUE);
                                          }
                                        }
                                      }
                                    }
